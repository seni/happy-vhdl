...
> import ProduceVHDLCode (produceVHDLParser)
...
%---------------------------------------
Branch off to VHDL parser production

>       if OptVHDL `elem` cli
>       then
>	let
>           outfiles = produceVHDLParser
>                       g
>                       action
>                       goto
>                       outfilename
>           showFiles  list = concatMap snd
>                             list
>           writeFiles list = sequence_
...
>    Option ['h'] ["vhdl"] (NoArg OptVHDL)
>	"Generate a parser in VHDL",
